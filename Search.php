...
<body>
   ...
   if (isset($_POST['btnSearch']))
   {
      ...
      $query = "SELECT * FROM Product
               WHERE ProductTypeID='Second Product'
   ...
   ?>
      ...
      {
         $query = "SELECT * from Product WHERE ProductTypeID='Second Product'
         ...
         if ($count > 0)
         {
            ...
            {
               $query1 = "SELECT * from Product WHERE ProductType='Second Product'
                                 ...
                                 <div>
                                    <div>
                                       ...
                                       <a href="seconddetail.php?PID=<?php echo $productcode ?>&qty=1"> <?php echo $name ?>
                                          <img src="<?php echo $image ?>" width="250px" height="250px">
                                       </a>
