...
if (isset($_POST['btnSend']))
{
   ...
   $txtcontactmessage = $_POST['txtcontactmessage'];
   $strippedtxtcontactmessage = str_replace("'", "''", $txtcontactmessage);
   $txtpolicy = $_POST['txtpolicy'];

   if ($txtpolicy == 'Agree')
   {
      $insert = "INSERT INTO ContactUs 
						(ContactName, ContactEmail, ContactMessage, ContactTimestamp)
                  VALUES('$txtcontactname','$txtcontactemail','$strippedtxtcontactmessage', CURRENT_TIMESTAMP())";
   ...
   if ($result)
   {
      echo "<script>window.alert('Thank you for messaging us. We will contact you soon! :)')</script>";
            ...
            <div class="col-lg-6 mx-auto">
               ...
               <div class="User-forms-section">
                  <form method="POST" action="Contact_Us.php" enctype="multipart/form-data">
                     <h5>Contact Name</h5>
                     <input type="text" name="txtcontactname" placeholder="Your Name" required>

                     <h5>Contact Email</h5>
                     <input type="email" name="txtcontactemail" placeholder="Email Address" required />

                     <h5>Message To HGE</h5>
                     <textarea name="txtcontactmessage" cols="30" rows="10" placeholder="Type your message here..." required></textarea>
         ...
         <div class="row">
            ...
            <div class="col-6 col-lg-3 col-md-3 col-sm-6">
               <div class="fs-widget">
                  <h4>Support</h4>
                  <ul>
                     <li><a href="./Contact_Us.php"><span class="Yellow-text">Contact Us</span> (You are here)</a></li>
                     <li><a href="./Customer_Register.php">Register</a></li>
                     <li><a href="./Customer_Login.php">Log in</a></li>
                  </ul>
               </div>
